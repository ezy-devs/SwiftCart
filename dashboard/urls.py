...
urlpatterns = [
    ...
    path('processing-orders', views.processing_orders, name='processing-orders'),
    path('shipped-orders', views.shipped_orders, name='shipped-orders'),
    path('delivered-orders', views.delivered_orders, name='delivered-orders'),
    path('cancelled-orders', views.cancelled_orders, name='cancelled-orders'),
